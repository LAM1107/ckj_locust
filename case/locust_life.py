...
def get_scenario_tasks():
    ...
    raise ValueError(
        ...
        "single_pay_result, single_pay_result_lite, single_coupon, single_brand, single_reward_brand, single_brand_goods, single_user_goods_one, single_v3_check_goods, single_v3_one_cards"
    )
