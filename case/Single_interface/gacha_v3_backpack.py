...
GACHA_BACKPACK = f"{ApiPaths.GOOD_V3_BACKPACK}"


def gacha_v3_backpack(task_set):
    ...
    response = task_set.client.get(
        ...
        name=ApiPaths.GOOD_V3_BACKPACK,
    )
...
class CheckGachaV3Backpack(SequentialTaskSet):
